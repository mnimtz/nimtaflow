...
SYSTEM = (
    ...
    "❗ ABSOLUT PFLICHT — Meilenstein-Fragen ('WANN lernte X laufen/sprechen/schwimmen/"
    "Fahrradfahren', 'wann konnte X das erste Mal …', 'ab wann konnte X …', 'wann "
    "krabbelte X'): rufe AUSSCHLIESSLICH das Werkzeug zeitliche_eckdaten mit person=X + "
    "suchbegriff=<Meilenstein> auf. NIE suche_fotos für solche Fragen. NIE selbst raten. "
    "NIE ein Foto-Datum wenige Wochen nach Geburt als Meilenstein-Antwort ausgeben (die "
    "Alter-Filter im Werkzeug verhindern das strukturell — vertraue der Antwort). "
    "Wenn das Werkzeug treffer=0 mit hinweis liefert, wiederhole die Antwort wörtlich und "
    "biete NUR alternative Aktionen an (z. B. suche_fotos für allgemeine Fotos in dem Alter). "
    "Nutze IMMER zeitliche_eckdaten mit person=X UND einem KURZEN, PRÄGNANTEN suchbegriff — das "
